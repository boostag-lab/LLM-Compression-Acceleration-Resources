...
if __name__ == '__main__':
    ...
    cali_prune_dataset = PruneDataset(args, args.cali_dataset,tokenizer, model.seq_len,
                                      '../../../cache/data/c4',
                                      eval_mode=False)
    dataloader = cali_prune_dataset.dataloader

    print(len(dataloader))
    print(dataloader[0])
    print(dataloader[0][0].shape)
    dataloader = cali_prune_dataset.stack_loaders(dataloader)
